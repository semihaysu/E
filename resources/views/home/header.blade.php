            ...
            <ul>
                ...
                <li><a href="{{route('userpanel.index')}}">HESABIM</a>
                    <ul class="header__menu__dropdown">
                        <li> @guest
                            <a href="/E/public/loginuser">Üye Giriş</a>
                        </li>
                        <li>
                            <a href="/E/public/registeruser">Üye Ol</a>
                            @endguest
                        </li>
                        <li> @auth
                        ...
                        <li> @auth
                            <a href="/E/public/logoutuser">Çıkış Yap</a>
                            @endauth
                        </li>
                    </ul>
                </li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> freely@gmail.com</li>
                                <li>Freely</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                <a href="/E/public/loginuser"><i class="fa fa-user"></i>Üye Giriş</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="{{route('userpanel.index')}}">HESABIM</a>
                                <ul class="header__menu__dropdown">
                                    <li> @guest
                                        <a href="/E/public/loginuser">Üye Girişi</a>
                                    </li>
                                    <li>
                                        <a href="/E/public/registeruser">Üye Ol</a>
                                        @endguest
